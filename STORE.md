...
A VS Code extension for cleaning up Git branches. "Sohji" means "cleaning" in Japanese.
...
2. Run **Git Sohji: Open** from the Command Palette (`Ctrl+Shift+P`)
3. Or click the branch icon in the SCM view title bar, or the **Git Sohji** icon in the Activity Bar
...
2. コマンドパレット（`Ctrl+Shift+P`）から **Git Sohji: 開く** を実行
3. または SCM ビューのタイトルバーにあるブランチアイコン、もしくはアクティビティバーの **Git Sohji** アイコンから起動
